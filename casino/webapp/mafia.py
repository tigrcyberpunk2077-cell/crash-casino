...
ACTIVITIES = {
    "kazino": {"label": "🎰 Крутить автомат", "out": [
        ...
        "🃏 Сел за покер с Крёстным — он блефовал, ты проиграл.",
        "💰 Поднял на рулетке и угостил всех у бара.",
        "🎲 Кости легли удачно — фартовая ночь!",
        "🚬 Крёстный позвал на разговор в VIP-зал…"]},
    "bar": {"label": "🍸 Выпить", "out": [
        ...
        "🎤 Спел в караоке про Дикий Запад, зал плакал.",
        "💃 Танцевал до утра, потерял ключи от хаты.",
        "👂 Подслушал, как двое шептались в углу 👀",
        "🍻 Выпил с Громилой на брудершафт — теперь он за тебя."]},
    "kvartira": {"label": "🎮 Погонять катку", "out": [
        ...
        "🍕 Заказал пиццу, курьер так и не дошёл.",
        "💻 Случайно нашёл переписку мафии… или показалось?",
        "🛋️ Уснул на диване под сериал.",
        "🎧 Врубил неон-фонк на всю — соседи в ярости."]},
    "kopeyka": {"label": "🚗 Дрифтануть", "out": [
        ...
        "🔧 Чинил движок полночи, руки в мазуте.",
        "📻 Поймал по радио шифровку мафии 📡",
        "⛽ Заправился на последние — на бак хватило.",
        "🏁 Сделал круг почёта по неон-кварталу."]},
    "rancho": {"label": "🐎 Покормить барана", "out": [
        ...
        "🌾 Собрал неон-сено, пахнет озоном.",
        "🤠 Пастух научил кидать лассо.",
        "🌙 Смотрел на звёзды, думал о жизни.",
        "🐾 Видел чьи-то следы у забора 👀"]},
    "turma": {"label": "⛓️ Отжаться", "out": [
        ...
        "🚬 Обменял сигу на инфу у вора в законе.",
        "🛏️ Не спал — сосед храпит как трактор.",
        "📨 Получил малявку с воли: «берегись».",
        "🏋️ Качал банку на турнике во дворе."]},
}
